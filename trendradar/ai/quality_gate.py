...
class AIQualityGate:
    ...
    def _judge_batch(self, items: List[Dict[str, Any]], mode: str) -> Dict[str, Dict[str, Any]]:
        ...
        system = (
            "你是一个“信息推送质量闸门”。你的任务是对候选新闻标题做快速复筛，"
            "只保留对 AI 产品经理有高价值的信息。"
            "高价值通常包括：AI/LLM/Agent 能力进展、AI 硬件与可穿戴（眼镜/耳机/手表/戒指等）、"
            "AR/VR/XR、语音/多模态、芯片与端侧推理、量产/供应链/合规（必须与上述领域相关）。"
            "应过滤：纯社会民生、娱乐八卦、体育、泛政治外交（除非与 AI 技术/产品/监管强相关）、"
            "以及仅因“成本/渠道/价格”等泛词命中的无关内容。"
        )
